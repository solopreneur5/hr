! function t(e, a, r) {
            ...
            ! function(t) {
                ...
                function l(t) {
                    ...
                    for (e = 0; e < f.length; e += 1)
                        if (a = f[e], n = t[a], void 0 === n) "negative" !== a || i.negativeBefore ? "mark" === a && "." !== i.thousand ? i[a] = "." : i[a] = !1 : i[a] = "-";
                        else if ("decimals" === a) {
        ...
        ! function(t) {
            ...
            function J(t, a, i) {
                ...
                function $(t) {
                    ...
                    var e = R(t.calcPoint),
                        r = N(e);
                    return r !== !1 && (a.events.snap || l(gt, a.cssClasses.tap, a.animationDuration), tt(r, e, !0, !0), Z(), H("slide", r, !0), H("update", r, !0), H("change", r, !0), H("set", r, !0), void(a.events.snap && I(t, {
                        handleNumbers: [r]
                    })))
                }
                ...
                function Q(t) {
                    ...
                    }), t.tap && F(ht.start, ut, $, {}), t.hover && F(ht.move, ut, L, {
                        hover: !0
                    }), t.drag && ft.forEach(function(e, r) {
                ...
                o.init(), this.each(function() {
                    ...
                    this.sfid = t.attr("data-sf-form-id"), n.addSearchForm(this.sfid, this), this.$fields = t.find("> ul > li"), this.enable_taxonomy_archives = t.attr("data-taxonomy-archives"), this.current_taxonomy_archive = t.attr("data-current-taxonomy-archive"), "undefined" == typeof this.enable_taxonomy_archives && (this.enable_taxonomy_archives = "0"), "undefined" == typeof this.current_taxonomy_archive && (this.current_taxonomy_archive = ""), i.init(e.enable_taxonomy_archives, e.current_taxonomy_archive), i.enableInputs(e), "undefined" == typeof this.extra_query_params && (this.extra_query_params = {
                        ...
                        this.inputTimer = 0, this.setInfiniteScrollContainer = function() {
                            ...
                            var a = 0,
                                n = !0;
                            1 == e.is_ajax && ("window" == e.scroll_to_pos ? a = 0 : "form" == e.scroll_to_pos ? a = t.offset().top : "results" == e.scroll_to_pos ? e.$ajax_results_container.length > 0 && (a = e.$ajax_results_container.offset().top) : "custom" == e.scroll_to_pos ? e.$custom_scroll_to.length > 0 && (a = e.$custom_scroll_to.offset().top) : n = !1, n && r("html, body").stop().animate({
                                scrollTop: a
                            }, "normal", "easeOutQuad"))
                            ...
                            if (1 == e.auto_update || 1 == e.auto_count_refresh_mode) {
                                ...
                                var a = t.find('input[type="text"]:not(.sf-datepicker)'),
                                    r = a.val();
                            ...
                            a.length > 0 && (a.each(function() {
                                ...
                                1 == e.is_rtl && (o.direction = "rtl"), t.datepicker(o), "" != e.lang_code ? r.datepicker.setDefaults(r.extend({
                                    dateFormat: a
                                }, r.datepicker.regional[e.lang_code])) : r.datepicker.setDefaults(r.extend({
                                    dateFormat: a
                            ...
                            var n = "",
                                ...
                                l = 0;
                            if ("undefined" != typeof r && s.hasOwnProperty(r) && o--, o > 0)
                                for (var u in s)
                            ...
                            if (n > 0)
                                for (var i in a) a.hasOwnProperty(i) && "" != a[i] && (r = i + "=" + a[i], t = e.joinUrlParam(t, r));
                            return t
                            ...
                            if (t.addClass("search-filter-disabled"), i.disableInputs(e), e.$ajax_results_container.animate({
                                    opacity: .5
                                }, "fast"), e.fadeContentAreas("out"), "pagination" == e.ajax_action) {
                            ...
                            var n = r(".searchandfilter[data-sf-form-id='" + e.sfid + "']");
                            n.trigger(t, [a])
                            ...
                            var n = this;
                            if ("json" == a) n.$ajax_results_container.html(e.results), "undefined" != typeof e.form && (t.off(), n.removeAjaxPagination(), n.copyListItemsContents(r(e.form), t), n.copyFormAttributes(r(e.form), t), t.searchAndFilter({
                                isInit: !1
                            }));
                            else if ("html" == a) {
                                var i = r(e);
                                if (n.$ajax_results_container.html(i.find(n.ajax_target_attr).html()), n.updateContentAreas(i), n.$ajax_results_container.find(".searchandfilter").length > 0 && n.$ajax_results_container.find(".searchandfilter").searchAndFilter(), 0 == n.$ajax_results_container.find(".searchandfilter[data-sf-form-id='" + n.sfid + "']").length) {
                            ...
                            var e = .5;
                            if ("in" === t && (e = 1), this.ajax_update_sections && this.ajax_update_sections.length)
                                for (index = 0; index < this.ajax_update_sections.length; ++index) {
                                    var a = this.ajax_update_sections[index];
                                    r(a).stop(!0, !0).animate({
                                        opacity: e
                                    }, "fast")
                                }
                            ...
                            if (1 == e.is_ajax) {
                                ...
                                var o = this.getBaseUrl(i),
                                    l = e.getQueryParamFromURL("lang", window.location.href);
        ...
        (function(t) {
            ...
            e.exports = {
                ...
                processAuthor: function(t) {
                    var e, a = this,
                        r = (t.attr("data-sf-field-type"), t.attr("data-sf-field-input-type")),
                        n = "",
                        i = "";
                    if ("select" == r) e = t.find("select"), n = e.attr("name").replace("[]", ""), i = a.getSelectVal(e);
                ...
                processTaxonomy: function(t, e) {
                    ...
                    var a, r = this,
                        ...
                        i = "",
                        s = "";
                    if ("select" == n) a = t.find("select"), i = a.attr("name").replace("[]", ""), s = r.getSelectVal(a);
                    else if ("multiselect" == n) {
                        a = t.find("select"),
    ...
    6: [function(t, e, a) {
        (function(t) {
            ...
            e.exports = {
                init: function() {
                    a(document).on("sf:ajaxfinish", ".searchandfilter", function(t, e) {
                        var r = e.object.display_result_method;
                        if ("custom_edd_store" === r) a("input.edd-add-to-cart").css("display", "none"), a("a.edd-add-to-cart").addClass("edd-has-js");
                        else if ("custom_layouts" === r && a(".cl-layout").hasClass("cl-layout--masonry")) {
